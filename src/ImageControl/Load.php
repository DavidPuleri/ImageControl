...
use ImageControl\Exception\FileNotFoundException;
use ImageControl\Exception\ThumbnailAlreadyExistsException;
use ImageControl\Exception\UnableToCreateFolderException;
use ImageControl\Exception\UnableToWriteToFolderException;
use ImageControl\Exception\ExtensionNotSupportedException;
